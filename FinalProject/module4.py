...
def main(method, number):
    ...
    if method == 'original':
        ...
        #print(number)
        if MyIPClass.dimensions == 'original':
            MyIPClass('done.png').changeHue(number).save()
        else:
            MyIPClass('done.png').changeHue(number).save()
        ...
        #print(number)
        if MyIPClass.currentState == 'original':
            MyIPClass('tigerFace.jpeg').changeSaturation(number).save()
        else:
            MyIPClass('tigerFace.jpeg').changeSaturation(number).save()
        ...
        #print(number)
        if MyIPClass.currentState == 'original':
            MyIPClass('done.png').changeValue(number).save()
        else:
            MyIPClass('done.png').changeValue(number).save()
        ...
        #print(number)
        if MyIPClass.currentState == 'original':
            MyIPClass('tigerFace.jpeg').glow().save()
        else:
            MyIPClass('done.png').glow().save()
